...
PARAM$finalmodel$semilla <- 150523

PARAM$finalmodel$num_iterations <- 559
PARAM$finalmodel$learning_rate <- 0.02141704
...
=======
archivo_importancia <- "impo_bin1.txt"
>>>>>>> 9e4f21f (Update File)
...
=======
    file = paste0(PARAM$experimento, "_", envios, "_bin1.csv"),
>>>>>>> 9e4f21f (Update File)
    sep = ","
  )
}
